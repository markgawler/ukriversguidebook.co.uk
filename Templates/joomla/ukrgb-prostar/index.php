...
/**
 * @package     Joomla.Site
 * @subpackage  Templates.ukrgbprotostar
 *
...
?>">
	...
	<div class="body">
		...
		<nav class="navigation navbar navbar-inverse navbar-fixed-top" role="navigation" ">
	...
	<footer class="footer" role="contentinfo">
		<div class="container<?php echo ($params->get('fluidContainer') ? '-fluid' : '');?>">
			...
			<p class="pull-right"><a href="#top" id="back-top"><?php echo JText::_('TPL_UKRGBPROTOSTAR_BACKTOTOP'); ?></a></p>
