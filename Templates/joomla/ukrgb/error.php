<?php
/**
 * @version		$Id: error.php,v 1.3 2011/12/02 17:48:01 mrfg Exp $
 * @package		Joomla.Site
...
<body>
	...
	<div id="all">
		...
		<header id="header">
			<?php endif; ?>
					<div class="logoheader">
						...
						<ul class="skiplinks">
							<li><a href="#wrapper2" class="u2"><?php echo JText::_('TPL_UKRGB_SKIP_TO_ERROR_CONTENT'); ?></a></li>
							<li><a href="#nav" class="u2"><?php echo JText::_('TPL_UKRGB_ERROR_JUMP_TO_NAV'); ?></a></li>

						</ul>
						<div id="line"></div>
					<div id="header-image">
					<img src="<?php echo $this->baseurl ?>/templates/ukrgb/images/fruits.jpg"  alt="<?php echo JText::_('TPL_UKRGB_LOGO'); ?>" />
					</div>
		...
		<div id="contentarea2" >
						...
						<?php endif; ?>
				<h2 class="unseen"><?php echo JText::_('TPL_UKRGB_NAVIGATION'); ?></h2>
